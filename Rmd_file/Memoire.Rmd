...
results <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + SELF.EMP + 
...
tab %>% flextable() %>% set_caption("Wage decomposition results (Oaxaca method)")
...
p8 <- discrim %>% ggplot(aes(gap_type, -value, fill = c("col1", "col2", "col3"))) + 
    ...
    scale_x_discrete(name = "Wage Gap") +
    ylab("") +
    theme_fivethirtyeight() +
    ...
    coord_flip() +
    labs(#title = "Structure des salaires au Quebec", #french version
         #subtitle = "\n Décomposition de l'écart salarial immigrants vs natifs \n", #english version
         title = "The wage structure in Quebec", 
         subtitle = 'Decomposing the wage gap between immigrants and Canadian born citizens', 
