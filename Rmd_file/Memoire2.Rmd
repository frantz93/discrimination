...
base <- read.csv("../datasets/pub0121.csv")
b0121 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
...
base <- read.csv("../datasets/pub0221.csv")
b0221 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0321.csv")
b0321 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0421.csv")
b0421 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0521.csv")
b0521 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0621.csv")
b0621 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0721.csv")
b0721 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0821.csv")
b0821 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0921.csv")
b0921 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTLAST, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub1021.csv")
b1021 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub1121.csv")
b1121 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub1221.csv")
b1221 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
...
base <- read.csv("../datasets/pub0122.csv")
b0122 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0222.csv")
b0222 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0322.csv")
b0322 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0422.csv")
b0422 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0522.csv")
b0522 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0622.csv")
b0622 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0722.csv")
b0722 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0822.csv")
b0822 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
                    WTIME = base$FTPTMAIN, TENURE = base$TENURE, UNION = base$UNION, 
                    FIRMSIZE = base$FIRMSIZE, HRLYEARN = base$HRLYEARN, DURUNEMP = base$DURUNEMP)
base <- read.csv("../datasets/pub0922.csv")
b0922 <- data.frame(ID = base$REC_NUM, SURVYEAR = base$SURVYEAR, SURVMNTH = base$SURVMNTH,
                    PROV = base$PROV, AGE = base$AGE_12, SEX = base$SEX, MARSTAT = base$MARSTAT,
                    EDUC = base$EDUC, IMMIG = base$IMMIG, PAID = if_else(!is.na(base$HRLYEARN), 1, 0),
                    CATWORK = if_else(base$COWMAIN == 1 | base$COWMAIN == 2, 1, 2), 
                    UNEMP = if_else(!is.na(base$DURUNEMP), 1, 0), OCCUP = base$NOC_10,
...
db <- rbind.data.frame(b0121,b0221,b0321,b0421,b0521,b0621,b0721,b0821,b0921,b1021,b1121,b1221,
                       b0122,b0222,b0322,b0422,b0522,b0622,b0722,b0822,b0922)
...
```{r statdesc}
db0422 <- db %>% filter(SURVYEAR==2022 & SURVMNTH==4)  #extract db for April 2022
baseQC <- db0422 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36))  #extract db for Quebec
...
occup <- tot[7:15,] %>% mutate(label = c("S1: Management", "S2: Business, finance and administration",
...
tab %>% flextable() %>% set_caption("Wage decomposition between Canadian born (A) and Immigrant (B)")
...
#plot(results, decomposition = "twofold", group.weight = 1, components = c("explained"), 
#     title = "Contribution des variables à la formation de l'écart expliqué")   
#round(results$twofold$variables[[2]][,2:3],3)   #coefficients de la formation des ecarts expliqués par le modèle

plot(results, components = c("endowments")) + ggtitle("Impact of workers' characteristics on wage gap")  #graphe de la formation des ecarts expliqués par les différences de caractéristiques
...
#test <- round(as.data.frame(results$x), 3) %>% rename(mean_nat = x.mean.A, mean_im = x.mean.B, diff = x.mean.diff)
#test <- test[-1,]
#test
...
```{r logit}
baseQC.chom <- baseQC %>% filter(ISUNEMP == 1) 
...
summary(reg2)                   #Variables SELF.EMP et OCCUP.SEC ne sont pas intégrées dans la regression par manque de données
#Variables TENURE + SYNDIC + LARGFIRM ne sont pas d'intérêt car ne concernent pas les chômeurs

round(exp(coef(reg2)), 2)   #Calcul des ratio Exp^B
...
#baseQC$T.UNEMP <- with(baseQC, ISUNEMP == 1) # des regressions Oaxaca et Fairlie

# 1- Caractéristiques des natifs (groupe A) vs les immigrants (groupe B)
X.B <- model.matrix(~ ISUNEMP + YOUNG + WOMAN + MARRIED + EDUC.LEVEL, data = baseQC[baseQC$IMMIGRANT == "1",])
X.A <- model.matrix(~ ISUNEMP + YOUNG + WOMAN + MARRIED + EDUC.LEVEL, data = baseQC[baseQC$IMMIGRANT == "0",])
...
#baseQC.chom$T.LONG.UNEMP <- with(baseQC.chom, LONG.UNEMP == 1) # des regressions Oaxaca et Fairlie
...
reg4 <- glm(ISUNEMP ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL, family = binomial(link = "logit"),
...
```{r ecart_decomp2}
# 2- Regression logit dans le groupe des natifs (groupe A)
reg4 <- glm(LONG.UNEMP ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL, family = binomial(link = "logit"),
            data=baseQC.chom[baseQC.chom$IMMIGRANT == "0",])

# 3- On predit les probabilités a partir des estimateurs des natifs (groupe A)
baseQC.chom$pA <- predict(reg4, baseQC.chom, type = 'response')
...
Nous vérifions l'évolution dans le temps de la discrimination contre les immigrants sur le marché du travail. Notre analyse se situe sur la période allant de janvier 2021 à avril 2022, période pour laquelle les données sont rendues disponibles par Statistique Canada.

```{r time_analysis}
db$T.IMMIG <- with(db, IMMIGRANT == 1)    #Variables de type 'logical'

#extract db for each survey
db0121 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==1)
db0221 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==2)
db0321 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==3)
db0421 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==4)
db0521 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==5)
db0621 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==6)
db0721 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==7)
db0821 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==8)
db0921 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==9)
db1021 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==10)
db1121 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==11)
db1221 <- db %>% filter(SURVYEAR==2021 & SURVMNTH==12)

db0122 <- db %>% filter(SURVYEAR==2022 & SURVMNTH==4)
db0222 <- db %>% filter(SURVYEAR==2022 & SURVMNTH==4)
db0322 <- db %>% filter(SURVYEAR==2022 & SURVMNTH==4)
db0422 <- db %>% filter(SURVYEAR==2022 & SURVMNTH==4)

#extract db for Quebec for each survey
baseQC_0121 <- db0121 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36,))
baseQC_0221 <- db0221 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0321 <- db0321 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0421 <- db0421 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0521 <- db0521 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0621 <- db0621 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0721 <- db0721 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0821 <- db0821 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0921 <- db0921 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_1021 <- db1021 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_1121 <- db1121 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_1221 <- db1221 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 

baseQC_0122 <- db0122 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36)) 
baseQC_0222 <- db0222 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36))
baseQC_0322 <- db0322 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36))
baseQC_0422 <- db0422 %>% filter(PROVINCE == "Québec") %>% select(c(20:34,36))

#extract db (ispaid) for Quebec for each survey
baseQC_0121p <- db0121 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37))
baseQC_0221p <- db0221 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0321p <- db0321 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0421p <- db0421 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0521p <- db0521 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0621p <- db0621 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0721p <- db0721 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0821p <- db0821 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0921p <- db0921 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_1021p <- db1021 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_1121p <- db1121 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_1221p <- db1221 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 

baseQC_0122p <- db0122 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37)) 
baseQC_0222p <- db0222 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37))
baseQC_0322p <- db0322 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37))
baseQC_0422p <- db0422 %>% filter(PROVINCE == "Québec" & ISPAID == 1) %>% select(c(20:34,36,37))


# examining discrimination in wages: running Oaxaca reg for each period
resultsQC_0121p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0121p, R = 100)
resultsQC_0221p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0221p, R = 100)
resultsQC_0321p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0321p, R = 100)
resultsQC_0421p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0421p, R = 100)
resultsQC_0521p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0521p, R = 100)
#---
resultsQC_0621p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0621p, R = 100)
resultsQC_0721p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0721p, R = 100)
resultsQC_0821p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0821p, R = 100)
resultsQC_0921p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0921p, R = 100)
resultsQC_1021p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_1021p, R = 100)
resultsQC_1121p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_1121p, R = 100)
resultsQC_1221p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_1221p, R = 100)


resultsQC_0122p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0122p, R = 100)
resultsQC_0222p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0122p, R = 100)
resultsQC_0322p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0122p, R = 100)
resultsQC_0422p <- oaxaca(formula = SAL ~ YOUNG + WOMAN + MARRIED + EDUC.LEVEL + 
                    OCCUP.SEC + PART.TIME + YRS.TENURE + SYNDIC + LARGFIRM | T.IMMIG, 
                  data = baseQC_0122p, R = 100)


tab_res_p <- data.frame(MONTH = date c("06/21","07/21","08/21","09/21","10/21",
                                "11/21","12/21","01/22","02/22","03/22","04/22"), 
                      UNEXP_SAL = c(resultsQC_0621p$twofold$overall[2,4],
                                    resultsQC_0721p$twofold$overall[2,4], resultsQC_0821p$twofold$overall[2,4],
                                    resultsQC_0921p$twofold$overall[2,4], resultsQC_1021p$twofold$overall[2,4],
                                    resultsQC_1121p$twofold$overall[2,4], resultsQC_1221p$twofold$overall[2,4],
                                    resultsQC_0122p$twofold$overall[2,4], resultsQC_0222p$twofold$overall[2,4],
                                    resultsQC_0322p$twofold$overall[2,4], resultsQC_0422p$twofold$overall[2,4]))

tab_res_p %>% ggplot(aes(MONTH, UNEXP_SAL)) + geom_line(stat = "identity") + 
  scale_x_discrete(limit=c("06/21","07/21","08/21","09/21","10/21",
                                "11/21","12/21","01/22","02/22","03/22","04/22"))
...
base.paid <- db0422 %>% filter(ISPAID == 1)
...
baseBC <- db0422 %>% filter(PROV==59)
baseMB <- db0422 %>% filter(PROV==46)
baseON <- db0422 %>% filter(PROV==35)
...
# Graphs
tab_all %>% ggplot(aes(UNEXP_pCHOM, UNEXP_SAL, label=PROV)) + geom_point(size=4, aes(col=PROV)) +
  ...
  labs(title = "Labor market discrimination toward immigrants in Canada", 
       ...
       caption = "©FRPDJ, Source:StatCan-04/2022")
